...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=ionos-cloud_sdk-go-dbaas-postgres&metric=alert_status)](https://sonarcloud.io/dashboard?id=ionos-cloud_sdk-go-dbaas-postgres)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=ionos-cloud_sdk-go-dbaas-postgres&metric=bugs)](https://sonarcloud.io/dashboard?id=ionos-cloud_sdk-go-dbaas-postgres)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=ionos-cloud_sdk-go-dbaas-postgres&metric=sqale_rating)](https://sonarcloud.io/dashboard?id=ionos-cloud_sdk-go-dbaas-postgres)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=ionos-cloud_sdk-go-dbaas-postgres&metric=reliability_rating)](https://sonarcloud.io/dashboard?id=ionos-cloud_sdk-go-dbaas-postgres)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=ionos-cloud_sdk-go-dbaas-postgres&metric=security_rating)](https://sonarcloud.io/dashboard?id=ionos-cloud_sdk-go-dbaas-postgres)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=ionos-cloud_sdk-go-dbaas-postgres&metric=vulnerabilities)](https://sonarcloud.io/dashboard?id=ionos-cloud_sdk-go-dbaas-postgres)
